...
# Buttons setup
HoverButton(
    button_frame, text="C", bg=ACCENT_COLOR, command=clear_all, **button_configs
...
HoverButton(
    button_frame, text="⌫", bg=ACCENT_COLOR, command=clear_button, **button_configs
...
HoverButton(
    ...
    text="π",
    bg=DARK_GRAY,
    command=lambda: click_button(3.1415),
    **button_configs
...
HoverButton(
    ...
    text="e",
    bg=DARK_GRAY,
    command=lambda: click_button(2.7182),
    **button_configs
...
HoverButton(
    ...
    command=lambda: click_button("+"),
    **button_configs
).grid(row=5, column=3, padx=2, pady=2)
